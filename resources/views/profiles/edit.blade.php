...
<div class="container" style="width: 900px;">
    <form action="/profile/{{ $user->id }}" enctype="multipart/form-data" method="post">
        @csrf <!-- To add csrf token input to the form and prevent crashing with 419 error -->
        @method('PATCH')
        ...
        <div class="col-8 offset-2">
            ...
            <div class="row">
            <label for="image" class="col-md-4 col-form-label">{{ __('Select Profile Image') }}</label>
